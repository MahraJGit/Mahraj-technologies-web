                ...
                <div className="relative rounded-[2.5rem] overflow-hidden border border-zinc-900 bg-black flex flex-col items-center group shadow-2xl">
                    ...
                    <div className="relative z-20 p-8 md:p-16 lg:p-24 flex flex-col lg:flex-row items-center justify-between w-full gap-12 lg:gap-16">
                        <div className="flex-1 text-center lg:text-left">
                            <h2 className="text-4xl xl:text-6xl font-black text-white uppercase leading-[1.05] md:leading-[0.95] lg:leading-[0.9] mb-8">
                        ...
                        <div className="flex flex-col sm:flex-row lg:flex-col xl:flex-row items-center justify-center gap-6">
                            <Link href="/contact" className="w-full sm:w-auto">
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.98 }}
                                    className="w-full sm:w-auto px-10 py-5 bg-primary border border-zinc-700 text-white text-xs uppercase font-bold transition-colors shadow-lg lg:min-w-[240px]"
                                >
                                    Contact Us
                                </motion.button>
                            </Link>
                            ...
                            <motion.button
                                ...
                                whileTap={{ scale: 0.98 }}
                                className="w-full sm:w-auto px-10 py-5 bg-white border border-zinc-700 text-black text-xs uppercase font-bold transition-all lg:min-w-[240px]"
                            >
                                Schedule a Call
                            </motion.button>
                        </div>
