    ...
    <section className="relative flex min-h-[calc(100vh-100px)] py-12 md:py-24 items-center justify-center bg-transparent overflow-hidden px-4">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center pt-8">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
          <Link href="/contact" className="px-10 py-4 w-full sm:w-auto text-sm font-bold text-body uppercase bg-primary rounded-full hover:bg-[#c91d26] transition-colors shadow-lg">
            Contact Us
          </Link>

          <Link href="/services" className="flex items-center gap-2 justify-center px-10 py-4 w-full sm:w-auto text-sm font-bold text-white uppercase transition-all duration-300 border border-zinc-700 rounded-full hover:border-primary hover:bg-primary/20 backdrop-blur-sm group">
            View Our Services
        ...
        <div className="mt-24 grid grid-cols-2 md:grid-cols-4 gap-8 border-t border-zinc-800/50 pt-12 max-w-3xl mx-auto">
          <div>
            ...
            <div className="text-[10px] text-zinc-500 uppercase">Client Satisfaction</div>
          </div>
          <div>
            <div className="text-2xl font-bold text-white mb-1">80%</div>
            <div className="text-[10px] text-zinc-500 uppercase">Visibility Growth</div>
          </div>
          <div>
            <div className="text-2xl font-bold text-white mb-1">70%</div>
            <div className="text-[10px] text-zinc-500 uppercase">Conversion Increase</div>
          </div>
          <div>
            <div className="text-2xl font-bold text-white mb-1">60%</div>
            <div className="text-[10px] text-zinc-500 uppercase">Lead Growth</div>
          </div>
        </div>
      </div>
