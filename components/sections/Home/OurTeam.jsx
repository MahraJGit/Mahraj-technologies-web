        ...
        <section className="bg-body py-20 overflow-hidden">
            <div className="w-full relative">
                ...
                <div className="relative w-full">
                    ...
                    <div className="relative z-10 bg-primary flex items-center justify-center overflow-hidden">
                        <div className="absolute top-[30%] -translate-y-1/2 left-0 w-full z-0 pointer-events-none">
                            <div className="flex w-max animate-marquee-infinite whitespace-nowrap opacity-20">
                                {[...Array(8)].map((_, i) => (
                                    <span key={i} className="text-white text-6xl md:text-9xl font-black uppercase px-12 tracking-tighter">
                                        WE GROW TOGETHER
                                    </span>
                                ))}
                            </div>
