    ...
    <section className="relative w-full min-h-[80vh] flex items-center border-b border-zinc-900/50 overflow-hidden">
      ...
      <div className="relative z-10 w-full px-4 sm:px-6 lg:px-8 xl:px-12 pt-16">
        <div className="max-w-5xl">
          <p className="text-primary  text-xs md:text-sm tracking-[0.3em] uppercase mb-6 md:mb-8">
            {eyebrow}
          </p>

          <h1 className="text-3xl sm:text-5xl md:text-7xl lg:text-[90px] font-black leading-[0.9] tracking-tighter uppercase mb-2">
